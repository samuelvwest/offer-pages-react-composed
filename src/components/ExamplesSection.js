                                ...
                                <div className="ancCol">
                                    <div className="topSpacing mb-6">
                                        <div className="borderLeft">
                                            <div className="borderInner">
                                                <img className="census lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.36/images/us-story-small.png" />
                                                ...
                                                <div className="usercontainer">
                                                    ...
                                                    <div className="userCardPile">
                                                        <span className="userCardImg userCardPortrait user-card-img-new" title="Person 1 Name, birth-death">
                                                            <img alt="" className="lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/heidi.png" />
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className={`story-wrap-mbl memberExpand topSpacing ${!/heidi/.test(this.state.storyExpanded) ? `noDisplay` : ``}`}>
                                                ...
                                                <div className="conBody">
                                                    <div className="flex-container">
                                                        <div className="example1-story-img example-leaf-container">
                                                            <div className="leaf-container">
                                                                <img className="circle-img lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.7/images/story1-img1.svg" /> 
                                                    ...
                                                    <div>
                                                        <div className="userCardContent example-user-content">
                                                            ...
                                                            <div className="story2-mbl-img-wrap-new rel-pos">
                                                                <img className="spacing-bottom-small story2-mbl-img-new lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.56/images/us-story-img1.png" />
                                                            </div>
                                                    ...
                                                    <div className="child2 show320">
                                                        <img className="mt-2 img-fluid-width mob-example-img rounded-sm lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.30/images/image85.png" />
                                                    </div>
                                                    ...
                                                    <div className="story-examples-two-panel section2">
                                                        <div className="child2">
                                                            <img className="mt-2 img-fluid-width mob-example-img hide320 show480 lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story1-crocs-img.png" />
                                                        </div>
                                                        <div className="child1">
                                                ...
                                                <div className="btnToggle topSpacing flex-container">
                                                    ...
                                                    <img className="mt-2 img-fluid-width mob-example-img story1-crocs-img show320 lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story1-crocs-img.png" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="topSpacing memberExpand blueContainer">
                                        <div className="borderLeft blue">
                                            <div className="borderInner">
                                                <img className="census lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.36/images/world-exp-small.png" />
                                                <div className="userCardContent">
                                                ...
                                                <div className="usercontainer">
                                                    ...
                                                    <div className="userCardPile">
                                                        <span className="userCardImg userCardPortrait user-card-img-new">
                                                            <img alt="" className=" lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.12/images/ben-c.png" />
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="conBody">
                                                    <div className="flex-container flex-center story2-main-container">
                                                        <div>
                                                            ...
                                                            <img className="story2-notes2-img hide320 show480 lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-notes2.png" />
                                                        </div>
                                                        <img className="story2-notes1-img lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-notes1.png" />
                                                    </div>
                                                    <div className="story2-main-sign-img">
                                                        <img className="story2-notes2-img show320 lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-notes2.png" />
                                                    </div>
                                                    ...
                                                    <div className="userCardContent example-user-content">
                                                        ...
                                                        <div className="story2-mbl-img-wrap-new rel-pos">
                                                            <img className="story2-mbl-img-new lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.30/images/320-480-exp2a.png" />
                                                        </div>
                                                    ...
                                                    <div className="flex-container flex-center">
                                                        ...
                                                        <img className="story2-pen-sign-img lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-pen-sign.png" />
                                                    </div>
                                                    <div className="userCardContent example-user-content">
                                                        <h6 className="userCardTitle">1901 U.K. Census Record</h6>
                                                        <p className="userCardSubTitle member-blue">Found in international records</p>
                                                        <div className="story2-mbl-img-wrap-new rel-pos">
                                                            <img className="story2-mbl-img-new lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.30/images/320-480-exp2b.png" />
                                                        </div>
                                                        <div className="mobile-example-title">The 1891 U.K. Census Record showing his grandpa as a “Oil + Colorman”.</div>
                                                    </div>
                                                    <div className="flex-container mt-2">
                                                        ...
                                                        <div>
                                                            <img className="lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-house-group.png" />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="topSpacing">
                                            <div className="borderLeft rel-pos example-pos">
                                                <div className="borderInner example-hero-wrap">
                                                    <img className="census example-hero-img rounded-2 lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.36/images/us-story-small.png" />
                                                    <div className="userCardContent">
                                                        <h6 className="userCardTitle topSpacing">My grandpa was a moonshine-making prisoner.</h6>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="sectionMargin">
                                                ...
                                                <div className="userCardContent">
                                                    <div className="usercontainer">
                                                        ...
                                                        <div className="userCardPile">
                                                            <span className="userCardImg userCardPortrait user-card-img-new" title="Person 1 Name, birth-death">
                                                                <img alt="" className="lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.10/images/heidi.png" />
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="ancCol w33">
                                        <div className="topSpacing memberExpand blueContainer">
                                            <div className="borderLeft worldex rel-pos example-pos">
                                                <div className="borderInner example-hero-wrap">
                                                    <img className="census example-hero-img rounded-2 lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.36/images/world-exp-small.png" />
                                                    <div className="userCardContent">
                                                        <h6 className="userCardTitle topSpacing">My 2nd great-grandfather was an oil-paint-peddling home decorator.</h6>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="ancCol w33">
                                        <div className="topSpacing memberExpand blueContainer">
                                            <div className="borderLeft allacc rel-pos example-pos">
                                                <div className="borderInner example-hero-wrap">
                                                    <img className="example-hero-img lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/example3-hero-img.png" />
                                                    <div className="userCardContent">
                                            ...
                                            <div className="sectionMargin">
                                                ...
                                                <div className="userCardContent">
                                                    <div className="usercontainer">
                                                        ...
                                                        <div className="userCardPile">
                                                            <span className="userCardImg userCardPortrait user-card-img-new">
                                                                <img alt="" className="lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/michelle.png" />
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className="conBody">
                                    <div className="flex-container">
                                        ...
                                        <div className="example1-story-desc-wrap">
                                            ...
                                            <div className="story1-sign-768-wrap rel-pos">
                                                <img className="story1-sign-768 rel-pos lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.30/images/story-sign-768.png" />
                                            </div>
                                            <div className="mobile-example-title">The 1930 census had him at the Warrensville Correction Farm.</div>
                                        </div>
                                    </div>
                                    <div className="flex-container mt-6 story1-bot-sec-wrap">
                                        <div className="example1-story-img1 pr-6 rel-pos">
                                            <img className="lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story1-img2-desk.png" />
                                        </div>
                                        <div className="example1-story-desc-wrap">
                                ...
                                <div className="conBody">
                                    <div className="flex-container">
                                        <div className="example2-story-sec1-img rel-pos">
                                            <img className="story2-notes-img lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-notes1.svg" />
                                        </div>
                                        <div className="example2-story-sec1">
                                            ...
                                            <div className="story1-sign-768-wrap rel-pos">
                                                <img className="story1-sign-768 rel-pos lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.30/images/story2-sign-768.png" />
                                            </div>
                                            <div className="mobile-example-title">The 1891 U.K. Census Record showing his grandpa as a “Oil + Colorman”.</div>
                                            <p>As an art and design practitioner himself, Ben began looking at other records for Frederick. He found out that Frederick changed his occupation from colorman to house decorator from the 1901 England Census.</p>
                                            <div className="userCardContent example-user-content">
                                            ...
                                            <div className="story1-sign-768-wrap rel-pos">
                                                <img className="story1-sign-768 rel-pos lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.30/images/story2-sign-1-768.png" />
                                            </div>
                                            ...
                                            <div className="example2-story-testimonial-container">
                                                ...
                                                <div className="example2-story-sec2-img">
                                                    <img className="lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story2-pen-sign.png" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="conBody">
                                    <div className="flex-container flex-center mb-4 story3-person-container">
                                        ...
                                        <div className="example3-story-sec1-img">
                                            <div>
                                                <figure>
                                                    <img className="story3-person lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.25/images/story3-person-desk.png" />
                                    ...
                                    <div className="story3-census-container">
                                        ...
                                        <div className="story1-sign-768-wrap rel-pos">
                                            <img className="story3-sign-768-1 rel-pos lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.29/images/story3-sign-768-1.png" />
                                        </div>
                                    ...
                                    <div className="article-container">
                                        <div className="left-wrapper">
                                            <div className="userCardContent example-user-content">
                                                ...
                                                <div className="story3-newspaper-wrapper">
                                                    ...
                                                    <img className="top-spacing-none lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.13/images/newpapers.svg" />
                                                </div>
                                            </div>
                                            <div className="story1-sign-768-wrap rel-pos">
                                                <img className="story1-sign-768 rel-pos lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.38/images/768+-np-AA.png" />
                                        ...
                                        <div className="right-wrapper mt-6">
                                            ...
                                            <p>I also have another perspective of the war from my father’s side of my family tree. It started with a shaky leaf hint from Ancestry on my family tree that indicated I might have a Civil War vet in the family. The hint was a Civil War muster roll. I eventually found a <img className="top-spacing-none img-as-text align-middle lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.13/images/newpapers.svg" /> article from 1951 that mentioned that my 3rd great grandfather—Isaac Rothwell—was a Civil War veteran. He served in the same regiment as his two brothers, Alfred and Samuel Rothwell.</p>
                                            <p>On <img className="top-spacing-none img-as-text lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.13/images/fold.svg" />, I was able to locate Isaac’s pension file—something that was necessary for me to have in order to request files at the National Archives.</p>
                                            ...
                                            <div className="userCardContent example-user-content">
                                                ...
                                                <div className="story3-persions">
                                                    <p className="userCardSubTitle member-purple">Found on</p>
                                                    <img className="top-spacing-none lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.13/images/fold.svg" />
                                                </div>
                                            </div>
                                            <div>
                                                <div className="story1-sign-768-wrap rel-pos">
                                                    <img className="story1-sign-768 rel-pos lazyImg" src="https://www.ancestrycdn.com/ui-static/i/loading/1/loading.png" data-src="https://www.ancestrycdn.com/pro-treeinteractions/prototypes/plan-select-mobile/0.0.54/images/story3-form.png" />
                                                </div>
