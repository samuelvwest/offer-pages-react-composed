...
import { AncestryLogo, Circle, IllustrationLeaf } from './SVGs';
...
const ExamplesSection = connect(mapStateToProps)((props) => {
    const pS = props.pageSettings;
    const subs = pS.subscriptions;
    return (
        <div className={`ancGrid ancGridEqual full480 exampleWrapper hide480 examples-outer-wrap-desk ${classesMaker(`sparkly-dragon`)}`}>
            ...
            <section className="con example-content">
                            ...
                            <div className="topSpacing">
                                ...
                                <div className="sectionMargin">
                                    ...
                                    <div className="btnToggle topSpacing">
                                        <button className="ancBtn see-story-btn full-width" type="button">See story</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="topSpacing memberExpand blueContainer">
                                ...
                                <div className="sectionMargin">
                                    ...
                                    <div className="userCardContent">
                                        <div className="usercontainer">
                                            <div className="userTitleWrapper">
                                                <h6 className="userCardTitle">Ben C.(<AncestryLogo /> Employee)
                                                </h6>
                                                <p className="userCardSubTitle usercard-subtitle-new">
                                                    <span className="user-subtitle-dot">
                                    ...
                                    <div className="btnToggle topSpacing">
                                        <button className="ancBtn blue see-story-btn full-width" type="button">See story</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="ancCol w33">
                            <div className="topSpacing memberExpand blueContainer">
                                ...
                                <div className="sectionMargin">
                                    ...
                                    <div className="btnToggle topSpacing">
                                        <button className="ancBtn allaccess-btn-bgcolor see-story-btn full-width" type="button">See story</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="story-wrap memberExpand mt-2 usdis-story-wrap-desk">
                    ...
                    <div className="conBody">
                        ...
                        <div className="btnToggle topSpacing textCenter storyCloseBtnContainer center-btn">
                            <button className="ancBtn stories-close-btn" type="button">Close</button>
                        </div>
                    </div>
                </div>
                <div className="story-wrap memberExpand mt-2">
                    ...
                    <div className="conBody">
                        ...
                        <div className="btnToggle topSpacing textCenter storyCloseBtnContainer center-btn">
                            <button className="ancBtn stories-close-btn blue" type="button">Close</button>
                        </div>
                    </div>
                </div>
                <div className="story-wrap memberExpand mt-2">
                    ...
                    <div className="conBody">
                        ...
                        <div className="btnToggle topSpacing textCenter storyCloseBtnContainer center-btn">
                            <button className="ancBtn stories-close-btn allaccess-btn-bgcolor" type="button">Close</button>
                        </div>
                    </div>
                </div>
            </section>
